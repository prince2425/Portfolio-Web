    ...
    <section>
      <div className="wrapper p-block-9 border-btn">
        <div className="text-center">
          <span
            className="sub-overlay-text text-6xl font-medium bg-linear-to-r from-orange-400 to-orange-600 bg-clip-text
                 text-transparent overlay-text  middle"
        ...
        <div
          ref={leftRef}
          className={`flex gap-5 mt-5 animate-left ${
