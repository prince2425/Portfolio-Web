    ...
    <header className="header">
      <nav className="flex between navbar    max-w-[1400px] mx-auto px-4 md:px-8  w-full">
        ...
        >
          ...
          <li>
            <AnchorLink href="#contactme" onClick={closeMenu} className="btn ">
              Let's Talk
            </AnchorLink>
          </li>
        </ul>
...
//                     <span className='gradient-text'>Prince Singh</span>
//                 </AnchorLink>
...
//                 <div className='nav-action flex items-center gap-3'>
//                     <button className='icon-container  border-inverse' onClick={toggleTheme}>
//                         {theme === 'dark' ? <MdOutlineWbSunny /> : <IoMoonOutline />}
//                     </button>
//                     {/* <AnchorLink href="#contact" className='btn'>Let's Talk</AnchorLink> */}
...
//                     <li><AnchorLink href="#home" className='link' onClick={closeMenu}>Home</AnchorLink></li>
//                     <li><AnchorLink href="#services" className='link' onClick={closeMenu}>Services</AnchorLink></li>
//                     <li><AnchorLink href="#about" className='link' onClick={closeMenu}>About Me</AnchorLink></li>
//                     <li><AnchorLink href="#projects" className='link' onClick={closeMenu}>Projects</AnchorLink></li>
//                     <li><AnchorLink href="#testimonials" className='link' onClick={closeMenu}>Testimonials</AnchorLink></li>
//                     <li><AnchorLink href="#contact" className='link' onClick={closeMenu}>Contact Me</AnchorLink></li>
//                     <li><AnchorLink href="#contact" className='btn' onClick={closeMenu}>Let's Talk</AnchorLink></li>
//                 </ul>
//             </nav>
//         </header>
//     );
