    ...
    <section>
      <div className="wrapper p-block-9 border-btn ">
        ...
        <div className="flex between gap-4   flex-col items-center justify-center text-center">
          ...
          <div >
            <span className=" text-6xl font-medium bg-gradient-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent" datatype="My Portfolio">
              My Portfolio
            </span>

            <h2 className="font-medium">
              Let's Have a look 
              at <span className="green-text">My Portfolio</span>
            </h2>
          </div>
